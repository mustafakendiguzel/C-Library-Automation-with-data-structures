...
oduncA *kayit(oduncA *ilkAlan,char istenilenKitap[40],char girilenAd1[40],kitaplar *ilk,ogrenciler *ilkOgrenci){
    ...
    while(temp != NULL){
        ...
        //Kayit fonksiyonunun olusturulmasinda https://forum.shiftdelete.net/konular/metindeki-kelimeleri-bagli-listeye-atma-yardim.184413/ linkindeki algoritmadan ve yapidan yararlandik.
